...
wtaHistory <- read_csv("wta_shiny_timeline.csv", col_names = T)
wtaRatings <- read_csv("wta_SR_ratings.csv", col_names = T)
wtaMatches <- read_csv("wta_shiny_matches.csv", col_names = TRUE)
