...
wtaHistory <- read_csv("wta_shiny_timeline_2021-05-21.csv", col_names = T)
wtaRatings <- read_csv("wta_SR_ratings_2021-05-21.csv", col_names = T)
wtaMatches <- read_csv("wta_shiny_matches_2021-05-21.csv", col_names = TRUE)
